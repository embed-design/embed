    ...
    return(
        ...
        <div className="items-center">
                <h1 className="pt-8 pb-8 text-center fontface-medium text-1xl md:text-2xl xl:text-3xl" > We have touched the following Industries with our work</h1>
                        ...
                        <section className="mx-2 p-10">
                            <div className="flex flex-wrap items-center align-middle ">
                                <div className="sm:w-1/3 md:w-1/3 px-4 lg:w-1/6 items-center align-middle">  <img className="rounded w-5/12" src="/assets/industrylogos/Ind_Ecommerce.svg" alt="E-Commerce "/><h3 className="align-center">E-Commerce</h3></div>
