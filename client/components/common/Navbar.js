            ...
            <div className="flex justify-between items-start py-2 md:py-6 ">
                ...
                <div className="flex items-center">
                    <div id="nav-list" className={`${navAnim ? "flex" : "transition delay-75 hidden" } items-center space-x-8 mr-8`}>
                        <a href="#" className={`${navAnim ? "animate-nav_in" : "animate-nav_out"} transition duration-500 ease-in-out ${darkMode ? "text-white" : "text-black"} fontface-medium text-xl hover:text-chocolate-600`}>Our Story</a>
                        <a href="#" className={`${navAnim ? "animate-nav_in" : "animate-nav_out"} transition duration-500 ease-in-out ${darkMode ? "text-white" : "text-black"} fontface-medium text-xl hover:text-chocolate-600`}>EmbedCast</a>
                        <a href="#" className={`${navAnim ? "animate-nav_in" : "animate-nav_out"} transition duration-500 ease-in-out ${darkMode ? "text-white" : "text-black"} fontface-medium text-xl hover:text-chocolate-600`}>Contact Us.</a>
                    </div>
